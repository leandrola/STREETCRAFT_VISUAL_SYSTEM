"""Primary reference-reasoning orchestration for the unified Streetcraft client."""
...
def resolve_reference(*, needs, profile, mode, camera, archive_retriever,
    ...
    return {'version': 'RR-2.0', 'status': status, 'queries': query_count,
