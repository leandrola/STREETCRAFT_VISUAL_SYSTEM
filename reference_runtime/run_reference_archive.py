"""Run Streetcraft reference reasoning with Archive and an explicit evidence catalog."""
import argparse,json,hashlib
from pathlib import Path
from archive_v1_adapter import make_archive_v1_retriever
from reference_reasoning import resolve_reference
...
def main():
    ...
    result=resolve_reference(**req,archive_retriever=make_archive_v1_retriever(a.archive_root,items))
