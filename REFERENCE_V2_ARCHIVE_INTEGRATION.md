...
Entrada ejecutable: reference_runtime/run_reference_v2_archive.py.
...
## Ejecución
python3 reference_runtime/run_reference_v2_archive.py --archive-root /ruta/STREETCRAFT_ARCHIVE_V1_FINAL --evidence /ruta/evidence_units.json --request /ruta/request.json --output /ruta/result.json
