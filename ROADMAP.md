...
5. **VSG-2A Generation Compiler Shadow: NEXT.** Próximo hito diagnóstico; no autoriza un compilador de producción ni cambios de generación. Cualquier entrada futura al runtime requiere su propio gate de preservación P0/PR0/PR1.
